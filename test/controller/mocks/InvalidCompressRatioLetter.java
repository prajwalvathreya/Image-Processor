...
/**
 * Class to test compression ratio where compression ratio is a letter.
 */
public class InvalidCompressRatioLetter extends JFrameView implements TestView {
  ...
  public List<String> getCommand() {
    commands.add("compress");
    commands.add("a");
    commands.add("test");
    commands.add("test-compress");
    return commands;
  }
