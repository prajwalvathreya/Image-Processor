...
/**
 * Class to test invalid load where file is not present.
 */
public class InvalidLoadFileDoesNotExist extends JFrameView implements TestView {
  ...
  public List<String> getCommand() {
    commands.add("load");
    commands.add("res/test/test-does-not-exist.png");
    commands.add("test");
    return commands;
  }
