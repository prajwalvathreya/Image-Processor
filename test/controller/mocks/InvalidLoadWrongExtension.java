...
/**
 * Class to test invalid load where file format is not supported.
 */
public class InvalidLoadWrongExtension extends JFrameView implements TestView {
