...
/**
 * This class represents a processor that converts a color image to red image.
 */
public class RedImageProcessor extends AbstractCreateGreyScaleProcessor {
  ...
  protected void setPostFilteredImage(Image preFilteredImage, Image postFilteredImage,
    ...
    for (int i = 0; i < preFilteredImage.getHeight(); i++) {
      for (int j = 0; j < width; j++) {
        ...
        postFilteredImage.getPixel(i, j).setRed(current.red());
